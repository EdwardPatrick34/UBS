							...
							<div class="d-flex align-items-end row">
								<div>
									<div class="card-body">
										...
										<br>
										<form action="<?php echo base_url('/Ccompkomputer/ubahpending')?>" method="POST">
											<div class="mb-12 row">
												<label for="uraian" class=" col-form-label">Keterangan Pending</label>
												<div class="col-sm-4 input-group input-group-merge">
												<textarea class="form-control" name="ket_pending" id="ket_pending"></textarea>
												</div>
											</div>
											<br>
