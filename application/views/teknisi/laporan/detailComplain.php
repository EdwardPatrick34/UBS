	...
	<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
		...
		<div class="content-wrapper">
			...
			<div class="container-xxl flex-grow-1 container-p-y">
				<h4 class="fw-bold py-3 mb-4"> History Complain</h4>
				<div class="col-sm-4 input-group input-group-merge">
					
					
					<a href="<?= base_url("CRTeknisi/LaporanHistoryComplain") ?>">
										...
										<div class="col-xl">
											<div class="card-body">
												...
												<div class="mb-12 row">
													...
													<div class="col-sm-4 input-group input-group-merge">
														<div style="width: 150px;">
															<input type="text"  id="tgl" name="tgl" readonly class="form-control" value="<?= $data->TANGGAL ?>">
														</div>
														&nbsp;
														&nbsp;
														<div style="width: 100px;">
															<input type="text"  id="jam" name="jam" readonly class="form-control" value="<?= $data->JAM ?>">
														</div>
													</div>
												</div>
												<br>
												<div class="mb-12 row">
													...
													<div class="col-sm-4 input-group input-group-merge">
													<input type="text" class="form-control" readonly name="nama_uc" id="nama_pelapor" value="<?= $data->PELAPOR ?>">
													</div>
												</div>																						
												<br>
												<div class="mb-12 row">
													...
													<div class="col-sm-4 input-group input-group-merge">
														<div style="width: 100px;">
															<input type="text"  id="kodedivisi" readonly name="kode_divisi"  class="form-control" value="<?= $data->DIVISI ?>">
														</div>
														&nbsp;
														&nbsp;
													</div>
												...
												<div class="mb-12 row">
													...
													<div class="col-sm-4 input-group input-group-merge">
													<input type="text" class="form-control" readonly name="kode_unit" id="kode_unit" value="<?= $data->KODE_UNIT ?>">
													</div>
												</div>
												<br>
												<div class="mb-12 row">
